...
function ProfileDetail(props) {
  ...
  return (
    <React.Fragment>
      ...
      <button type="button" onClick={() => onClickingDelete(profile.id)}>Delete Profile</button>
      <button type="button" onClick={() => props.onClickingSaveAsJSONFile(profile)}>Save Profile to JSON File</button>
    </React.Fragment>
  );
}
