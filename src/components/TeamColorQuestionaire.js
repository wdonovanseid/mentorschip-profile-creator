    ...
    <React.Fragment>
      ...
      <form onSubmit={props.formSubmissionHandler}>
        <ul>
          ...
          <li>10. I hate it when other people.....
            <p><input type="radio" name="q10" value={1}></input>A. are indecisive about what activities to do when I am with them.</p>
            <p><input type="radio" name="q10" value={0}></input>B. plan activities in step-by-step detail when I am with them.</p>
          </li>
        </ul>
        <button type="submit">Submit Questionaire</button>
      </form>
      <button type="button" onClick={props.onReturnToProfileDetails}>Return to Profile Details</button>
    </React.Fragment>
  );
}
